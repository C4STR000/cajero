...
/**
 * Panel para realizar transferencias de una cuenta a otra.
 */
public class PanelTransferir extends javax.swing.JPanel {

    /**
     * Crea un nuevo PanelTransferir.
     *
     * @param divisa Divisa seleccionada para la transferencia.
     * @param gestionador Gestor de cuentas asociado al usuario.
     * @param panelOpciones Panel de opciones del cajero.
     * @param registro Modelo de tabla para registrar eventos.
    ...
    public PanelTransferir(String divisa, GestorCuenta gestionador, Container panelOpciones, DefaultTableModel registro, JFrame panelPrincipal) {
        ...
        // Acción del botón para transferir
        btnTranferir.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (montoExistente >= montoATranferir) {
                    ...
                    gestionador.transferir(lblDivisa.getText().toLowerCase(), montoATranferir, numCuenta);

                    // Crear eventos de transferencia
                    ...
                    gestionador.crearEvento(new Evento(numCuenta, "Se realizó una transferencia entrante desde:" + gestionador.getNroCuenta(), Double.toString(montoConvertidoDestino), gestionador.saldoDisponible()));
