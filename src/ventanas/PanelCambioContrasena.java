...
/**
 * Panel para cambiar la contraseña de la cuenta.
 */
public class PanelCambioContrasena extends javax.swing.JPanel {
     ...
     * @param panelOpciones Contenedor de opciones donde se muestra este panel
     * @param registro      Modelo de tabla para mostrar eventos
    ...
    public PanelCambioContrasena(GestorCuenta gestionador, Container panelOpciones, DefaultTableModel registro, JFrame panelPrincipal) {
        ...
        // Acción del botón "Confirmar Cambio"
        btnConfirmaCambio.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                // Validar la contraseña antigua y el cambio de contraseña
                ...
                if (contrasenaCoincide && nuevaContrasenaCoincide) {
                    lblAviso.setText("Se cambió la contraseña con éxito.");
                    lblAviso.setForeground(new Color(0, 153, 0));
                } else {
                    lblAviso.setText("No se pudo realizar el cambio de contraseña.");
        ...
        btnAtras.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                // Si se presiona "Atrás", se vuelve al panel de opciones
