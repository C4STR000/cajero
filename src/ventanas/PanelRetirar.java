...
/**
 * Panel para realizar la operación de retiro de fondos.
 */
public class PanelRetirar extends javax.swing.JPanel {
     ...
     * 
     * @param divisa Divisa en la que se realizará el retiro.
     * @param gestionador Gestor de cuenta asociado al cajero.
     * @param panelOpciones Panel de opciones del cajero.
     * @param registro Modelo de tabla para los registros de eventos.
    ...
    public PanelRetirar(String divisa, GestorCuenta gestionador, Container panelOpciones, DefaultTableModel registro, JFrame panelPrincipal) {
        ...
        // Configuración de los textos iniciales
        ...
        btnRetirar.addActionListener(new ActionListener() {
            /**
             * Acción al hacer clic en el botón "Retirar".
             * Realiza la operación de retiro y actualiza la tabla de eventos.
             * 
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (montoExistente >= montoARetirar && montoARetirar > 0) {
                    ...
                    gestionador.retirar(divisa.toLowerCase(), montoARetirar); // Realizar el retiro
                    ...
                    lblAviso.setText("Saldo Insuficiente");
                    lblAviso.setForeground(new Color(204, 0, 0));
                }
            }
        });
        ...
        btnAtras.addActionListener(new ActionListener() {
             ...
             * Vuelve al panel de opciones del cajero.
             * 
             * @param e Evento de acción.
             */
            @Override
